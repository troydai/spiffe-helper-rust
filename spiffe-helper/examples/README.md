...
In this mode:
1. `spiffe-helper-rust` fetches the initial certificates.
...
In this mode:
1. `spiffe-helper-rust` fetches and writes certificates.
...
```bash
spiffe-helper-rust --config examples/managed_process.conf
```
