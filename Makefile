...
DEPLOY_SPIRE_SCRIPT := $(ROOT_DIR)/scripts/spire-server/deploy.sh
UNDEPLOY_SPIRE_SCRIPT := $(ROOT_DIR)/scripts/spire-server/undeploy.sh
CHECK_SPIRE_SCRIPT := $(ROOT_DIR)/scripts/check-spire-server.sh
DEPLOY_SPIRE_AGENT_SCRIPT := $(ROOT_DIR)/scripts/spire-agent/deploy.sh
UNDEPLOY_SPIRE_AGENT_SCRIPT := $(ROOT_DIR)/scripts/spire-agent/undeploy.sh
DEPLOY_REGISTRATION_SCRIPT := $(ROOT_DIR)/scripts/registration/deploy.sh
UNDEPLOY_REGISTRATION_SCRIPT := $(ROOT_DIR)/scripts/registration/undeploy.sh
DEPLOY_SPIRE_CSI_SCRIPT := $(ROOT_DIR)/scripts/spire-csi/deploy.sh
UNDEPLOY_SPIRE_CSI_SCRIPT := $(ROOT_DIR)/scripts/spire-csi/undeploy.sh
DEPLOY_HTTPBIN_SCRIPT := $(ROOT_DIR)/scripts/httpbin/deploy.sh
UNDEPLOY_HTTPBIN_SCRIPT := $(ROOT_DIR)/scripts/httpbin/undeploy.sh
SMOKE_TEST_SCRIPT := $(ROOT_DIR)/scripts/test/smoke-test.sh
KIND ?= kind
...
load-helper-image: check-cluster build-helper-image
	@echo "$(COLOR_CYAN)[load-helper-image]$(COLOR_RESET) Loading spiffe-helper image into kind cluster..."
